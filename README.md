...
총 **4개 프로젝트**가 **3개 도메인**에 등록되어 있습니다.

| 도메인 | 프로젝트 수 | 주요 키워드 |
|-------|-----------|------------|
| [Database](./database) | 2 | Aurora MySQL 튜닝, Valkey 마이그레이션 |
| [AI/ML](./ai-ml) | 1 | Graviton 전환 (AWS Transform Custom) |
| [Developer Tools](./developer-tools) | 1 | AI 개발 워크플로우 (Kiro) |
...
### 🗄️ [Database](./database) - 데이터베이스 서비스 (2개 프로젝트)
관계형, NoSQL, 인메모리, 그래프 데이터베이스 등 다양한 데이터 저장 요구사항 지원

**핵심 서비스**: Aurora, DynamoDB, RDS, ElastiCache, MemoryDB, DocumentDB

- [aurora-mysql-parameter-group-tuning](./database/aurora-mysql-parameter-group-tuning/) - Aurora MySQL 3.10.3 Parameter Group 튜닝 가이드
- [valkey-migration](./database/valkey-migration/) - Redis → ElastiCache for Valkey 온라인 마이그레이션 테스트
...
### 🤖 [AI/ML](./ai-ml) - 인공지능 및 머신러닝 (1개 프로젝트)
생성형 AI부터 커스텀 ML 모델까지 다양한 AI/ML 워크로드 지원

**핵심 서비스**: Bedrock, SageMaker, Amazon Q Developer, Kiro, Amazon Nova, Rekognition, Textract

- [x86-to-graviton-with-aws-transform-custom](./ai-ml/x86-to-graviton-with-aws-transform-custom/) - AWS Transform Custom을 활용한 x86 Java 앱의 Graviton 전환 가이드
...
### 🛠️ [Developer Tools](./developer-tools) - 개발자 도구 (1개 프로젝트)
CI/CD 파이프라인, 인프라스트럭처 as Code, 애플리케이션 모니터링

**핵심 서비스**: Kiro, CDK, CloudFormation, Code*

- [structured-ai-dev-workflow](./developer-tools/structured-ai-dev-workflow/) - Kiro Subagent 기반 Multi-agent AI 개발 워크플로우 설계
